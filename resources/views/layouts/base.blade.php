...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{url('/home')}}" class="brand-link">
      ...
      <span class="brand-text font-weight-bold font-weight-light">Pizzeria Delimar</span>
    </a>
  ...
  <footer class="main-footer text-sm">
    ...
    <strong>Copyright &copy; 2023 <a href="" target="_blank">EN DESARROLLO</a>.</strong> Todos los derechos reservados.
  </footer>
 --}}
</div><!-- ./wrapper -->
